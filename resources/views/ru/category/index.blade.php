...
@section('content')
    ...
    <form action="{{route('rucategories.store')}}" method="POST">
        @csrf
        <div class="mb-1">
    ...
    @foreach($articles  as $value)
        <div class="card mt-2">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <a href="{{route('rucategories.edit', $value['id'])}}" class="btn btn-outline-primary">Edit</a>
                    <form class="ml-1" action="{{route('rucategories.destroy', $value['id'])}}" method="POST">
                        @method('DELETE')
                        @csrf
