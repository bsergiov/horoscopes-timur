...
@section('content')
    ...
    <form action="{{route('enover.store')}}" method="POST">
        @csrf
        <div class="mb-1">
    ...
    @foreach($articles  as $value)
        <div class="card mt-2">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <a href="{{route('enover.edit', $value['id'])}}" class="btn btn-outline-primary">Edit</a>
                    <form class="ml-1" action="{{route('enover.destroy', $value['id'])}}" method="POST">
                        @method('DELETE')
                        @csrf
